...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://gitee.com/tang-yu-xiao-bao/image-bad/raw/master/Blog/dm14.webp);
    --darkmode-bg:url(https://gitee.com/tang-yu-xiao-bao/image-bad/raw/master/Blog/yuanshen1.webp);
    --mobileday-bg: url(https://gitee.com/tang-yu-xiao-bao/image-bad/raw/master/Blog/snow.webp);
    --mobilenight-bg: url(https://gitee.com/tang-yu-xiao-bao/image-bad/raw/master/Blog/mb8.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/tang-yu-xiao-bao/image-bad/raw/master/Blog/mb4.webp)" class="pimgbox" onclick="changeBg('url(https://gitee.com/tang-yu-xiao-bao/image-bad/raw/master/Blog/mb4.webp)')"></a></div>
              </div>
            </details>
